...
class ArtInfo extends Component {
        render() {
            ...
            <p>{this.props.german ? <>Acryl auf Leinwand</> : <>Acrylic on canvas</>}, 100 x 100 cm</p>
                <a target="_blank" href="https://petra-kleiboemer.de/kaestchentechnik.html">Original</a>
            ...
            Her special box technique for her "shifted pictures" (in Frisian: Fersköwen biljen) is her trademark</>}</p>
                <p></p>
                <a target="_blank" href="https://petra-kleiboemer.de/biografie.html">{this.props.german ? <>Biographie</> : <>Biography</>}
</a>
                <h4>E-Mail: </h4>
