    ...
    render() {
        return (
            <div className="startPage_div">
                ...
                <div className="photo">
                    <img className = "photoStartPage staticPhoto" style= {{"opacity": this.state.opacity1 }} src="./image/HZ_Logo.jpg" alt="HZ Logo"></img>
                    <img className = "photoStartPage fadingPhoto1" style={{"opacity": this.state.opacity2 }} src="./image/holger.png" alt="Holger Zerbe"></img>
                    <img className = "photoStartPage fadingPhoto2" style={{"opacity": this.state.opacity3 }} src="./image/code.png" alt="HZ Code"></img>
                    </div>
