    ...
    render() {
        return (
            <div className="startPage_div">
                ...
                <div className="photo">
                    <img className = "photoStartPage staticPhoto" style= {{"opacity": this.state.opacity1 }} src={process.env.PUBLIC_URL +"./image/HZ_Logo.jpg"} alt="Holger Zerbe Logo"></img>
                    <img className = "photoStartPage fadingPhoto1" style={{"opacity": this.state.opacity2 }} src={process.env.PUBLIC_URL +"./image/holger.png"} alt="Holger Zerbe"></img>
                    <img className = "photoStartPage fadingPhoto2" style={{"opacity": this.state.opacity3 }} src={process.env.PUBLIC_URL + "./image/code.png"} alt="Holger Zerbe"></img>
                    </div>
